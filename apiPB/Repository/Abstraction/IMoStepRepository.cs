...
namespace apiPB.Repository.Abstraction
{
    public interface IMoStepRepository
    {
        ...
        /// </returns>
        IEnumerable<VwApiMostep> GetMostepWithJob(MostepRequestFilter filter);
        ...
        /// IEnumerable di VwApiMostep: restituisce una collezione generica di modelli VwApiMostep
        /// </returns>
        IEnumerable<VwApiMostep> GetMostepWithMono(MostepRequestFilter filter);
        ...
        /// IEnumerable di VwApiMostep: restituisce una collezione generica di modelli VwApiMostep
        /// </returns>
        IEnumerable<VwApiMostep> GetMostepWithOperation(MostepRequestFilter filter);
    }
}